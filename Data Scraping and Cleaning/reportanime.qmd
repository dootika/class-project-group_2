...
-   After that the distance matrix was rounded upto 2 decimal places.
    ...
    2.  If (i,j,1)^th^ element of dark distance matrix lies between $[0,0.2]$, call it a darker shade. Such elements are counted.

    3.  If (i,j,2)^th^ element of white distance matrix lies between $[0,0.2]$, call it a lighter shade. Such elements are counted.
