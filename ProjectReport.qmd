...
-   What should be the color composition of your poster?
    ...
    -   Since an RGB analysis may not give us a simplistic understanding of a model approach to the problem, we also try a Dark and White theme analysis on the posters.

-   For a particular audience, what anime genre performs the best on an average?

    -   One might assume that Manga performs better on average for a target audience of young adults. However, for a younger audience such as 5-10 year olds, originals like \"Shin-Chan\" and \"Doraemon\" might perform better.
...
=======
#| warning: FALSE
>>>>>>> 44877d2d0530b07940afb6dd98c1f2822918e355
library(ggplot2)
