...
-   What season should you release the anime in?
    ...
    -   Does the viewership actually increase during summer time?
        ...
        In the following plot we can actually observe that the average number of viewers for shows dipped for the shows that were released during the summer months. This is an interesting observation that is counter-intuitive to our original line of thought.
...
-   What should be the color composition of your poster?
    ...
    -   Since an RGB analysis does not give us a clear trend, we also try a Dark and White theme analysis on the posters.
        ...
        Here, we can observe interesting trends. For example the "Mystery" genre seems to have darker posters at at average. While the comedy genre has lighter posters. This enables us to think more on the lines of how light and dark colors affect our psychology and how this fact may be exploited to create a greater demand for our product.

-   For a particular audience, what anime genre performs the best on an average?

    -   One might assume that Manga performs better on average for a target audience of young adults. However, for a younger audience such as 5-10 year-old children, originals like "Shin-Chan" and "Doraemon" might perform better.
...
We can notice that there is no specific combination of characteristics which guarantees a hit anime but it depends on how the person who is making the Anime wants to make it.
